...
The goal of [dockerfiler](https://thinkr-open.github.io/dockerfiler/) is
to provide an easy way to create Dockerfiles from R.
...
Conduct](https://thinkr-open.github.io/dockerfiler/CODE_OF_CONDUCT.md).
