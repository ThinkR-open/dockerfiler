...
- [`get_sysreqs()`](https://github.com/ThinkR-open/golemversetemplate/reference/get_sysreqs.md)
  : Get system requirements
- [`compact_sysreqs()`](https://github.com/ThinkR-open/golemversetemplate/reference/compact_sysreqs.md)
  : Compact Sysreqs
...
- [`docker_ignore_add()`](https://github.com/ThinkR-open/golemversetemplate/reference/docker_ignore_add.md)
